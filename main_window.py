...
class MainWindow(QMainWindow):
    ...
    def showcam(self):
            ...
            if names!= []:
                ...
                for n in names:
                    ...
                    if n not in self.detected_people:
                        ...
                        self.ui.listWidget.addItem(n+' was detected')
        ...
        if 'Unknown' in self.detected_people:
            self.detected_people.remove('Unknown')

        df = pd.DataFrame({'RollNumbers':self.detected_people})
